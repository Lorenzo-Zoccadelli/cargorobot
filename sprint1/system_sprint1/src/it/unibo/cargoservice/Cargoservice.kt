		...
		return { //this:ActionBasciFsm
				...
				state("wait_requests") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t026",targetState="elaboraRichiesta",cond=whenRequest("richiestaCarico"))
					transition(edgeName="t027",targetState="handleResetStiva",cond=whenRequest("resetStiva"))
					interrupthandle(edgeName="t028",targetState="handleAnomalia",cond=whenEvent("rilevazioneAnomalia"),interruptedStateTransitions)
				}	 
				state("elaboraRichiesta") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t029",targetState="datiProdottoRicevuti",cond=whenReply("getProductAnswer"))
					interrupthandle(edgeName="t030",targetState="handleAnomalia",cond=whenEvent("rilevazioneAnomalia"),interruptedStateTransitions)
				}	 
				state("datiProdottoRicevuti") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t031",targetState="assegnamentoSlot",cond=whenTimeout("local_tout_"+name+"_datiProdottoRicevuti"))   
					transition(edgeName="t032",targetState="wait_requests",cond=whenDispatch("endLocal"))
					interrupthandle(edgeName="t033",targetState="handleAnomalia",cond=whenEvent("rilevazioneAnomalia"),interruptedStateTransitions)
				}	 
				state("assegnamentoSlot") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t034",targetState="waitContainer",cond=whenTimeout("local_tout_"+name+"_assegnamentoSlot"))   
					transition(edgeName="t035",targetState="wait_requests",cond=whenDispatch("endLocal"))
					interrupthandle(edgeName="t036",targetState="handleAnomalia",cond=whenEvent("rilevazioneAnomalia"),interruptedStateTransitions)
				}	 
				state("waitContainer") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t037",targetState="caricaProdotto",cond=whenEvent("containerRilevato"))
					interrupthandle(edgeName="t038",targetState="handleAnomalia",cond=whenEvent("rilevazioneAnomalia"),interruptedStateTransitions)
				}	 
				state("caricaProdotto") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t039",targetState="caricamentoTerminato",cond=whenReply("slotCaricato"))
					transition(edgeName="t040",targetState="problemaCaricamento",cond=whenReply("caricamentoFallito"))
					interrupthandle(edgeName="t041",targetState="handleAnomalia",cond=whenEvent("rilevazioneAnomalia"),interruptedStateTransitions)
				}	 
				...
				state("handleAnomalia") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t042",targetState="resumeFromAnomalia",cond=whenEvent("risoluzioneAnomalia"))
				}	 

		...
		return { //this:ActionBasciFsm
				...
				state("ledOff") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t062",targetState="ledOn",cond=whenEvent("rilevazioneAnomalia"))
				}	 
				state("ledOn") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="t063",targetState="ledOff",cond=whenEvent("risoluzioneAnomalia"))
				}	 
			}
		}
} 
